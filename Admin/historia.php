<?php
    ...
    if($usuario == null || $usuario = ''){
        ...
        require_once 'Views/historia.view.php';
    }
	    ...
	    foreach($Historia as list($id, $titulo, $subtitulo, $contenido, $imagen)){
		    ...
		    echo" 
                <tr>
                    ...
                    <td>
                        <a href='editar-historia.php?id=$id' class='btn btn-warning btn-icon-split btn-block'><span class='icon text-white-50'><i class='fas fa-edit'></i></span><span class='text'>Editar</span></a><div class='my-2'></div>

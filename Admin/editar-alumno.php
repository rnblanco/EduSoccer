	...
	function Cargar(){
		...
		foreach($Alumnos as list($id, $nombre, $edad, $nacimiento, $ingreso, $matricula, $imagen, $padre, $padreTel, $madre, $madreTel, $contacto, $categoria)){
			...
			echo"
                ...
                <div class='form-group'> <label class='form-control-label'>Contacto * :</label> <input value='$contacto' onkeypress='javascript:return cprotection(event)' type='email' id='contacto' class='form-control ' onblur='validate1(9)'></input></div>

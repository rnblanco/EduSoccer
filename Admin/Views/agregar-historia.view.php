...
<body id="page-top">
          ...
          <div class="container-fluid px-1 mx-auto">
            <div class="row d-flex justify-content-center">
                <div class="col-xl-10 col-lg-11 col-md-12">
                    <div class="card b-0">
                        <h4 class="heading">Agregar una historia</h4>
                        <form action="../Db/agregarHistorial.php" method="post" enctype="multipart/form-data" id="form">
                            <div class="form-card">
                              ...
                              <div class='form-group'> <label class='form-control-label'>Fecha:</label> <input onkeypress='javascript:return notnumprotection(event)' type='text' id='subtitulo' class='form-control' onblur='validate1(4)'></div>
  ...
  <script src="js/agregar-historia.js"></script>
